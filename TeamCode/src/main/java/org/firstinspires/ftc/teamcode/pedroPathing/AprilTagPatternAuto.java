...
/*  Example Motif - Responding to AprilTags with PedroPathing
https://pedropathing.com/docs/pathing/examples/apriltagpatternauto
...
@Autonomous(name = "Example PedroPathing using AprilTags", group = "Examples")
@Configurable // Panels
